...
class __TwigTemplate_5884d52bd300c984e026273a868d61d8e755e0b308e82af3cd364dd4b4455a14 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/bartik/templates/classy/content-edit/filter-tips.html.twig", "/var/www/artem/web/core/themes/bartik/templates/classy/content-edit/filter-tips.html.twig");
    }
